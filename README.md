...
| `:network` | Owns OkHttp/Retrofit and all API/network work. The only module allowed to depend on Square's networking libraries directly. | [`network/README.md`](network/README.md) |
